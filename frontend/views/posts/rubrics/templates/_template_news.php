            ...
            <div class="row">
                <div class="col-xs-12 col-xxsm-12 col-xsm-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="grid__item">
                        <a href="<?= NewsHelper::url($news[0]); ?>" class="analysis analysis_roubric">
                                ...
                                <?php for ($f = 1; $f < 5; $f++):
                                    ...
                                    <li class="band__item">
                                        <div class="band__content">
                                            <a href="<?= NewsHelper::url($post); ?>" class="band__name title">
                ...
                <?php if (isset($news[$s])):
                    ...
                    <div class="row">
                        <div class="col-xs-12  col-xxsm-12 col-xsm-12  col-sm-4 col-md-6 col-lg-6">
                            <div class="grid__item">
                                <a href="<?= NewsHelper::url($news[$s]); ?>" class="card card_full card_full_biggest" style="background-image:url(<?= $news[$s]->getRectanglePicture(); ?>);">
                                    <div class="card__photo">
