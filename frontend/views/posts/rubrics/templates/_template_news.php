            ...
            <div class="row">
                <div class="col-xs-12 col-xxsm-12 col-xsm-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="grid__item">
                        <a href="<?= Url::toRoute(['posts/rubrics/post', 'rubric' => $news[0]->rubricAssignments[0]->rubric->slug, 'post' => $news[0]->alias]); ?>" class="analysis analysis_roubric">
                                ...
                                <?php for ($f = 1; $f < 5; $f++):
                                    ...
                                    <li class="band__item">
                                        <div class="band__content">
                                            <a href="<?= Url::toRoute(['posts/rubrics/post', 'rubric' => $post->rubricAssignments[0]->rubric->slug, 'post' => $post->alias]); ?>" class="band__name title">
                ...
                <div class="row">
                    <?php for($s = $f; $s < $f + 2; $s++):
                        ...
                        <div class="col-xs-12  col-xxsm-12 col-xsm-6  col-sm-6 col-md-6 col-lg-6" data-id="<?= $post->id;?>">
                            <div class="grid__item">
                                <a href="<?= Url::toRoute(['posts/rubrics/post', 'rubric' => $post->rubricAssignments[0]->rubric->slug, 'post' => $post->alias]); ?>" class="card card_full card_full_biggest" style="background-image:url(<?= $post->getRectanglePicture();?>);">
                ...
                <?php if (isset($news[$s])):
                    ...
                    <div class="row">
                        <div class="col-xs-12  col-xxsm-12 col-xsm-12  col-sm-4 col-md-6 col-lg-6">
                            <div class="grid__item">
                                <a href="<?= Url::toRoute(['posts/rubrics/post', 'rubric' => $post->rubricAssignments[0]->rubric->slug, 'post' => $news[$s]->alias]); ?>" class="card card_full card_full_biggest" style="background-image:url(<?= $news[$s]->getRectanglePicture(); ?>);">
                                    <div class="card__photo">
                            ...
                            <div class="row">
                                <?php for ($t = ++$s; $t < $s + 2; $t++):
                                    ...
                                    <div class="col-xs-12 col-xxsm-12 col-xsm-6 col-sm-6 col-md-6 col-lg-6">
                                        <div class="grid__item">
                                            <a href="<?= Url::toRoute(['posts/rubrics/post', 'rubric' => $post->rubricAssignments[0]->rubric->slug, 'post' => $post->alias]); ?>" class="card card_standart card_border  card_background_gray">
                                                <div class="card__photo">
                                                    <img src="<?= $post->getRectanglePicture();?>" alt="<?= Html::encode($post->title); ?>">
                                                </div>
                                                <div class="card__content">
