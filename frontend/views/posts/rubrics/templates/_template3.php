                ...
                <div class="row">
                    <?php for($s = $f; $s < $f + 2; $s++):
                        ...
                        <div class="col-xs-12  col-xxsm-12 col-xsm-6  col-sm-6 col-md-6 col-lg-6" data-id="<?= $post->id;?>">
                            <div class="grid__item">
                                <a href="<?= Url::toRoute(['posts/rubrics/post', 'rubric' => $rubric->slug, 'post' => $post->alias]); ?>" class="card card_full card_full_biggest" style="background-image:url(<?= $post->getRectanglePicture();?>);">
                ...
                <?php if (isset($news[$s])):
                    ...
                    <div class="row">
                        <div class="col-xs-12  col-xxsm-12 col-xsm-12  col-sm-4 col-md-6 col-lg-6">
                            <div class="grid__item">
                                <a href="<?= Url::toRoute(['posts/rubrics/post', 'rubric' => $rubric->slug, 'post' => $news[$s]->alias]); ?>" class="card card_full card_full_biggest" style="background-image:url(<?= $news[$s]->getRectanglePicture(); ?>);">
                                    <div class="card__photo">
