    ...
    <?php for ($f = 0; $f < 2; $f++):
        ...
        <div class="col-xs-12  col-xxsm-12 col-xsm-6  col-sm-6 col-md-6 col-lg-6">
            <div class="grid__item">
                <a href="<?= NewsHelper::url($article); ?>" class="card card_full card_full_biggest" style="background-image:url(<?= $article->getRectanglePicture();?>);">
    ...
    <div class="row">
        <?php for($s = $f; $s < count($news); $s++):
            ...
            <div class="col-xs-12  col-xxsm-12 col-xsm-6  col-sm-6 col-md-3 col-lg-3">
                <div class="grid__item">
                    <a href="<?= NewsHelper::url($article, $isNews ? $article->rubricAssignments[0]->rubric->slug : $rubric); ?>" class="card card_standart card_border  card_background_gray">
                        <div class="card__photo">
