        ...
        <div class="row">
            ...
            <?php if ($news[$i]):
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                    <div class="grid__item">
                        <a href="<?= Html::encode(Url::toRoute(['rubrics/post', 'rubric' => $alias, 'post' => $post->alias])); ?>" class="analysis analysis_text">
                    ...
                    <div class="row">
                        <?php for($s = $i; $s < $i + 2; $s++):
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" data-id="<?= $post->id;?>">
                                <div class="grid__item">
                                    <a href="<?= Html::encode(Url::toRoute(['rubrics/post', 'rubric' => $alias, 'post' => $post->alias])); ?>" class="card card_small">
                        ...
                        if ($news[$s]): ?>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="grid__item">
                                    <a href="<?= Html::encode(Url::toRoute(['rubrics/post', 'rubric' => $alias, 'post' => $post->alias])); ?>" class="clipping clipping_card">
            ...
            <div class="row">
                <?php for($t = $s; $t < count($news); $t++):
                    ...
                    <div class="col-xs-12 col-xxsm-12 col-xsm-6 col-sm-6 col-md-6 col-lg-6">
                        <div class="grid__item">
                            <a href="<?= Html::encode(Url::toRoute(['rubrics/post', 'rubric' => $alias, 'post' => $post->alias])); ?>" class="card card_full card_full_biggest" style="background-image: url('<?= $post->getRectanglePicture();?>');">
                                <div class="card__photo">
                                    <img src="<?= $post->getRectanglePicture();?>" alt="<?= Html::encode($post->title);?>">
                                    <div class="card__content">
