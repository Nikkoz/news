                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 hide-xsm hide-xxsm hide-xs">
                        <div class="grid__item">
                            <a href="<?= Html::encode(NewsHelper::url($post, $alias)); ?>" class="analysis analysis_flat" data-id="<?= $post->id;?>">
                    ...
                    <div class="row">
                        <?php for($i = 1; $i <= 2; $i++):
                            ...
                            <div class="col-xs-12 col-xxsm-12 col-xsm-6 col-sm-6 col-md-6 col-lg-6">
                                <div class="grid__item">
                                    <a href="<?= Html::encode(NewsHelper::url($post, $alias)); ?>" class="card card_standart card_background_gray">
